...
class LandingPageTest(SeleniumTestCase):
    ...
    def test_user_logout(self):
        ...
        self.browser.find_element_by_css_selector('#navbarNavDropdown')
        self.browser.find_element_by_css_selector('#identity')
        self.browser.find_element_by_css_selector('#user-term-role')
